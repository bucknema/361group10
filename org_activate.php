<?php # Script 18.7 - org_activate.php
...
if (isset($_GET['x'], $_GET['y']) 
	...
	// Update the database...
	require (MYSQL);
	$q = "UPDATE organization SET active=NULL WHERE (email='" . mysqli_real_escape_string($dbc, $_GET['x']) . "' AND active='" . mysqli_real_escape_string($dbc, $_GET['y']) . "') LIMIT 1";
